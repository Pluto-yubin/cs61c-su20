...
mapLoop:
    ...
    # mistake 4: la a0, 8(s0)
	lw a0, 8(s0)		# load the address of the next node into a0
	# mistake 5 lw a1, 0(s1)
    add a1. x0. s0      # put the address of the function back into a1 to prepare for the recursion
