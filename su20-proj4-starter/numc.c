...
static PyObject* Matrix61c_add(Matrix61c* self, PyObject* args)
{
    ...
    if (!PyObject_TypeCheck(args, &Matrix61cType)) {
        PyErr_SetString(PyExc_TypeError, "arg 2 should be type of Matrix61c");
        return NULL;
    }
    int row = self->mat->rows, col = self->mat->cols;
    if (row != ((Matrix61c*)args)->mat->rows || col != ((Matrix61c*)args)->mat->cols) {
        PyErr_SetString(PyExc_RuntimeError, "the dimension of two matrixs should be the same");
    }
    PyObject* matrix = _PyObject_New(self->ob_base.ob_type);
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    add_matrix(((Matrix61c*)matrix)->mat, self->mat, ((Matrix61c*)args)->mat);
    return matrix;
}
...
static PyObject* Matrix61c_sub(Matrix61c* self, PyObject* args)
{
    ...
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    sub_matrix(((Matrix61c*)matrix)->mat, self->mat, ((Matrix61c*)args)->mat);
    return matrix;
}
...
static PyObject* Matrix61c_multiply(Matrix61c* self, PyObject* args)
{
    ...
    int row = self->mat->rows, col = self->mat->cols;
    if (col != ((Matrix61c*)args)->mat->rows) {
        PyErr_SetString(PyExc_RuntimeError, "cols of matrix 1 should be the same rows of matrix 2");
        return NULL;
    }
    PyObject* matrix = _PyObject_New(self->ob_base.ob_type);
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    mul_matrix(((Matrix61c*)matrix)->mat, self->mat, ((Matrix61c*)args)->mat);
    return matrix;
}
...
static PyObject* Matrix61c_neg(Matrix61c* self)
{
    ...
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    neg_matrix(((Matrix61c*)matrix)->mat, self->mat);
    return matrix;
}
...
static PyObject* Matrix61c_abs(Matrix61c* self)
{
    ...
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    abs_matrix(((Matrix61c*)matrix)->mat, self->mat);
    return matrix;
}
...
static PyObject* Matrix61c_pow(Matrix61c* self, PyObject* pow, PyObject* optional)
{
    ...
    int powi = 0;
    if (!PyLong_Check(pow)) {
        PyErr_SetString(PyExc_TypeError, "arg 2 should be type of int");
        return NULL;
    }
    powi = PyLong_AS_LONG(pow);
    PyObject* matrix = _PyObject_New(self->ob_base.ob_type);
    allocate_matrix(&(((Matrix61c*)matrix)->mat), row, col);
    fill_matrix(((Matrix61c*)matrix)->mat, 0);
    pow_matrix(((Matrix61c*)matrix)->mat, self->mat, powi);
    return matrix;
}
...
static PyObject* Matrix61c_set_value(Matrix61c* self, PyObject* args)
{
    ...
    if (PyArg_UnpackTuple(args, "args", 1, 3, &arg1, &arg2, &arg3)) {
        /* arguments are (rows, cols, val) */
        if (arg1 && arg2 && arg3 && PyLong_Check(arg1) && PyLong_Check(arg2) && (PyLong_Check(arg3) || PyFloat_Check(arg3))) {
            long row = PyLong_AS_LONG(arg1);
            long col = PyLong_AS_LONG(arg2);
            long val = PyFloat_AS_DOUBLE(arg3);
            self->mat->data[row * self->mat->rows + col] = val;
        } else {
            PyErr_SetString(PyExc_TypeError, "Invalid arguments");
        }
    } else {
...
static PyObject* Matrix61c_get_value(Matrix61c* self, PyObject* args)
{
    ...
    if (PyArg_UnpackTuple(args, "args", 1, 2, &arg1, &arg2)) {
        ...
        if (arg1 && arg2 && PyLong_Check(arg1) && PyLong_Check(arg2)) {
            long row = PyLong_AS_LONG(arg1);
            long col = PyLong_AS_LONG(arg2);
            double val = self->mat->data[row * self->mat->rows + col];
