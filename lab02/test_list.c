...
int main()
{
    ...
    *head_ptr = malloc(sizeof(node));
    ...
    int is_correct = list_size(head_ptr) == 2 && last_node != NULL && last_node->val == 2 && last_node->next == NULL;
    ...
    is_correct = list_size(head_ptr) == 3 && last_node != NULL && last_node->val == 3 && last_node->next == NULL;
